...
const CourseUpload = () => {
  ...
  return (
    <div className="w-full p-6 mx-44">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        {/* Media Uploads */}
        <Card className="p-6">
          <h2 className="text-2xl font-semibold mb-4">Course Media</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
        ...
        <Card className="p-6">
          ...
          <AnimatePresence>
            {sectionFields.map((section, sIndex) => (
              ...
              >
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg font-medium">Section {sIndex + 1}</h3>
                  <Button
                    isIconOnly
                    color="danger"
                    variant="light"
                ...
                <div className="ml-4">
                  <div className="flex justify-between items-center mb-3">
                    <h4 className="text-base font-medium">Lessons</h4>
                    <Button
                      size="sm"
                      color="primary"
                      variant="flat"
                  ...
                  {watch(`sections.${sIndex}.lessons`)?.map((lesson, lIndex) => (
                    <div key={lesson.id} className="border-l-2 pl-4 mb-4">
                      <div className="flex justify-between items-center mb-2">
                        <h5 className="text-sm font-medium">Lesson {lIndex + 1}</h5>
                        <Button
                          isIconOnly
                          color="danger"
                          variant="light"
          ...
          {!watch('isFree') && (
            <AnimatePresence>
              {priceTierFields.map((tier, index) => (
                ...
                >
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="text-lg font-medium">Price Tier {index + 1}</h3>
                    <Button
                      isIconOnly
                      color="danger"
                      variant="light"
