  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-6">
      ...
      <Tabs 
        ...
        color="primary"
      >
        <Tab key="ebooks" title="Upload Ebooks">
          <form onSubmit={ebookHandleSubmit(onEbookSubmit)} className="space-y-8">
            {/* Ebook Information */}
            <Card className="p-6">
              <h2 className="text-2xl font-semibold mb-4">Ebook Information</h2>
            ...
            {/* Ebook Media */}
            <Card className="p-6">
              <h2 className="text-2xl font-semibold mb-4">Ebook Media</h2>
                  ...
                  {ebookWatch('ebookFile') ? (
                    <div className="relative">
                      <div className="flex items-center gap-2 p-2 border rounded">
                        <File size={24} />
                        <span>{ebookWatch('ebookFile').name}</span>
                      </div>
                      <button
                        type="button"
                ...
                <div>
                  ...
                  {ebookWatch('sampleFile') ? (
                    <div className="relative">
                      <div className="flex items-center gap-2 p-2 border rounded">
                        <File size={24} />
                        <span>{ebookWatch('sampleFile').name}</span>
                      </div>
                      <button
                        type="button"
            ...
            {/* DRM Settings */}
            {/* <Card className="p-6">
              <h2 className="text-2xl font-semibold mb-4">Digital Rights Management (DRM)</h2>
              <Controller
                name="drmEnabled"
                control={ebookControl}
                render={({ field }) => (
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        {...field}
                        type="number"
                        label="Allowed Prints"
                        placeholder="Enter number of allowed prints (0 for none)"
                        className="w-full"
                      />
                    )}
                  />
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        placeholder="Enter number of allowed copies (0 for none)"
                        className="w-full"
                      />
                    )}
                  />
        ...
        <Tab key="coupons" title="Upload Coupons">
          <form onSubmit={couponHandleSubmit(onCouponSubmit)} className="space-y-8">
            {/* Coupon Information */}
            <Card className="p-6">
              <h2 className="text-2xl font-semibold mb-4">Coupon Information</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Controller
                  name="code"
                  control={couponControl}
            ...
            <Card className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl font-semibold">Applicable Items</h2>
                <Button
                  color="primary"
                  variant="flat"
              ...
              <Table aria-label="Applicable Items Table">
                <TableHeader>
