...
function CuponCode() {
  ...
  const onEditSubmit = async (data) => {
    ...
    try {
      const response = await fetch(`http://bonnbackend.up.railway.app/api/v1/codes/update-code?cuponId=${selectedCupon._id}`, {
        method: 'PUT',
        headers: {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await fetch(`http://bonnbackend.up.railway.app/api/v1/codes/create-code?name=${data.cuponCode.toUpperCase()}&minOrderValue=${data.minOrderValue}&expiryDate=${data.date}&discountPercentage=${data.discountPercentage}`, {
        method: 'POST',
      });
  ...
  const getCuponCodes = async () => {
    ...
    try {
      const response = await fetch("http://bonnbackend.up.railway.app/api/v1/codes/get-code", {
        method: "GET"
      });
  ...
  const deleteCode = async (cuponId, name) => {
    try {
      const response = await fetch(`http://bonnbackend.up.railway.app/api/v1/codes/delete-code?cuponId=${cuponId}`, {
        method: "DELETE"
      });
